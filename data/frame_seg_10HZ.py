...
def save_frame_mask_pairs(frames_folder, masks_folder, output_csv):
    ...
    for i, frame_file in enumerate(frames):
        ...
        mask_index = frame_number // frames_per_mask  # 每10帧对应一个mask
...
#     frames_folder = f'/home/disk1/lyf/seg/data/test/video_{i}/frames_10HZ'
#     masks_folder = f'/home/disk1/lyf/seg/data/test/video_{i}/segmentation'
#     output_csv = f'/home/disk1/lyf/seg/data/test/video_{i}/frames_segmentation_10HZ.csv'

#     save_frame_mask_pairs(frames_folder, masks_folder, output_csv)
# train
for i in tqdm.trange(30, 41):
    frames_folder = f'/home/disk1/lyf/seg/data/train/video_{i}/frames_10HZ'
    masks_folder = f'/home/disk1/lyf/seg/data/train/video_{i}/segmentation'
    output_csv = f'/home/disk1/lyf/seg/data/train/video_{i}/frames_segmentation_10HZ.csv'

    save_frame_mask_pairs(frames_folder, masks_folder, output_csv)


# for i in tqdm.trange(1,3):
#     frames_folder = f'/home/disk1/lyf/seg/data/train/video_15_{i}/frames_10HZ'
#     masks_folder = f'/home/disk1/lyf/seg/data/train/video_15_{i}/segmentation'
#     output_csv = f'/home/disk1/lyf/seg/data/train/video_15_{i}/frames_segmentation_10HZ.csv'
